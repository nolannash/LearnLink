...
router.get('/:teacherId/account', passport.authenticate('jwt', { session: false }), (req, res) => {
	TeacherController.viewOwnAccount(req, res);
});

//? Update teacher profile
router.patch('/:teacherId/update', passport.authenticate('jwt', { session: false }), (req, res) => {
	TeacherController.updateTeacherProfile(req, res);
});

//? Update teacher password
router.patch('/:teacherId/update/password', passport.authenticate('jwt', { session: false }), (req, res) => {
