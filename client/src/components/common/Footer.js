...
const Footer = () => {
  return (
    <div className="grid grid-cols-3 gap-4 p-4 bg-gray-200 h-40">
      ...
      {/* Links Column */}
      <div className="col-span-1 flex items-center justify-center">
        <div className="text-center">{/* Add your links here */}</div>
      </div>
      ...
      <div className="col-span-1 flex items-center justify-center">
        <div className="flex justify-center space-x-4">
          <a
            href="https://www.linkedin.com/in/derrick-c-19659211a/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-green-400 hover:text-blue-500 transform transition-transform"
          >
            <FontAwesomeIcon icon={faLinkedin} size="3x" />
          </a>
          <a
            href="https://github.com/dcleavall"
            target="_blank"
            rel="noopener noreferrer"
            className="text-green-400 hover:text-blue-500 transform transition-transform"
          >
          ...
          <a
            href="https://medium.com/@dcleavall"
            target="_blank"
            rel="noopener noreferrer"
            className="text-green-400 hover:text-blue-500 transform transition-transform"
          >
